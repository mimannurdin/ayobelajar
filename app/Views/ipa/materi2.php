        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-left">
                    <h3 class="font-weight-medium">Materi 2</h3>
                    <h5 class="mb-5">Mengenal Macam-macam Perubahan Wujud Benda yang ada di Sekitar Kita!</h5>
                </div>
            </div>
            <div class="row" data-aos="fade-up">
                <div class="col text-left">
                    <video width="60%" height="auto" src="<?= base_url('themes/videos')?>/ipa-materi-2.mp4" controls poster="<?= base_url('themes/images')?>/thumbnail2.png"></video>
                </div>
            </div>
            <div class="row " style="margin: 0 0.2rem;" data-aos="fade-up">
                <div class="col">
                    <a href="<?= base_url('ipa/soal2_1')?>" class="btn btn-primary" style="position: absolute; right: 16px; bottom: 8px;">Selanjutnya</a>
                </div>
            </div>
        </div>
    </section>
